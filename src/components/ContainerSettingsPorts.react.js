  ...
  render: function () {
    ...
    var ports = _.map(_.pairs(this.state.ports), pair => {
      ...
      if (key === '') {
        ...
        portKey = <input class="line" id={'portKey' + key} type="number" disabled={isUpdating} defaultValue={key} />;
        portValue = <input class="line" id={'portValue' + key} type="number" disabled={isUpdating} defaultValue={port} />;
      }else {
        ...
        portKey = <input class="line" id={'portKey' + key} type="number" onChange={this.handleChangePortKey.bind(this, key)} disabled={isUpdating} defaultValue={key} />;
        portValue = <input class="line" id={'portValue' + key} type="number" onChange={this.handleChangePort.bind(this, key)} disabled={isUpdating} defaultValue={port} />;
      }
      return (
        <tr key={key}>
          <td>{portKey}</td>
